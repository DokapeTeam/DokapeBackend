...
class UserController @Autowired constructor(
    ...
    @GetMapping("/me")
    fun getUser(@RequestHeader("Authorization") token: AuthToken): UserResponse {
        val id = tokenProvider.getUserIdFromJWT(token.removeBearer())
        return userService.getUserResponse(id) ?: throw ResponseStatusException(HttpStatus.FORBIDDEN, "User not found")
    }
